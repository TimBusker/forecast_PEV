...
This script regrids the EFI, SOT and rainfall (E-OBS) files to the same resolution (0.25 degrees). 
...
lead_times= ['1 days', '2 days', '3 days', '4 days', '5 days'] # lead times
...
############################################# load ref grid (ECMWF 0125 degree file) #################################
